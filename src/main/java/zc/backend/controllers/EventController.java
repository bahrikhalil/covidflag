...
import zc.backend.modles.Ratings;
...
public class EventController {
    ...
    @Autowired
    public  EventController(EventServiceImpl service,EventRepo eventRepo){
   ...
   @RequestMapping("posting/{eventName}")
    public void postRating(@PathVariable String eventName,@RequestBody Ratings rating){
        rating.setEventName(eventName);
        this.restTemplate.postForObject("http://localhost:8888/api/postRating",rating,Ratings.class);
    }
