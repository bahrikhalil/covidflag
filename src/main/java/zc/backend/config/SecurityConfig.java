...
*/
    ...
    public void configure(WebSecurity web) throws Exception {
        web
                .ignoring()
                .antMatchers(  "/api/feedback","/api/user/role/test ","/api/user/addtoUser","/api/event/eventing/*","/api/event/all","/api/event/ratings/*","/api/user/all","/api/user/att","/api/event/posting/*");
